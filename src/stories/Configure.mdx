...
<Meta title="Welcome to DAZN Design System" />

<div className="sb-container">
  <div className='sb-section-title'>
    # This is DAZN Design System

    This is a collection of components, patterns and guidelines to help you build consistent and accessible user interfaces across DAZN products. It is built with Storybook, a tool for developing UI components in isolation for React, Vue, Angular, and more.
